  ...
  return (
    <>
      ...
      <main>
        ...
        >
         Hello! I’m Sai Prasath, a web developer <br />
         based in Bangalore, Karnataka. I specialize in crafting <br />
         visually stunning websites with seamless user experiences.
        ...
        <section className="relative h-screen flex justify-center items-center mx-16 md:mx-0 text-xl md:text-2xl text-center">
          <div>
            ...
            and im a solo developer and looking for a work Too <br />
            If you’d like me to join your team, please reach me out!
          </div>

          <Link
            href="/Sai prasath CV.pdf"
            target="_blank"
